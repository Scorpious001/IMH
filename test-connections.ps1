...
try {
    ...
    try {
        ...
        Write-Host "   ✗ Failed to parse JSON response: $_" -ForegroundColor Red
        Write-Host "   Response content: $($csrfResponse.Content)" -ForegroundColor Yellow
        exit 1
    }
} catch {
...
try {
    ...
    try {
        ...
        Write-Host "   ✗ Failed to parse JSON response: $_" -ForegroundColor Red
        Write-Host "   Response content: $($loginResponse.Content)" -ForegroundColor Yellow
        exit 1
    }
} catch {
...
try {
    ...
    try {
        ...
        Write-Host "   ✗ Failed to parse JSON response: $_" -ForegroundColor Red
        Write-Host "   Response content: $($userResponse.Content)" -ForegroundColor Yellow
    }
} catch {
...
try {
    ...
    try {
        ...
        Write-Host "   ✗ Failed to parse JSON response: $_" -ForegroundColor Red
        Write-Host "   Response content: $($itemsResponse.Content)" -ForegroundColor Yellow
    }
} catch {
...
try {
    ...
    try {
        ...
        Write-Host "   ✗ Failed to parse JSON response: $_" -ForegroundColor Red
        Write-Host "   Response content: $($locationsResponse.Content)" -ForegroundColor Yellow
    }
} catch {
...
try {
    ...
    try {
        ...
        Write-Host "   ✗ Failed to parse JSON response: $_" -ForegroundColor Red
        Write-Host "   Response content: $($stockResponse.Content)" -ForegroundColor Yellow
    }
} catch {
...
try {
    ...
    try {
        ...
        Write-Host "   ✗ Failed to parse JSON response: $_" -ForegroundColor Red
        Write-Host "   Response content: $($alertsResponse.Content)" -ForegroundColor Yellow
    }
} catch {
...
try {
    ...
    try {
        ...
        Write-Host "   ✗ Failed to parse JSON response: $_" -ForegroundColor Red
        Write-Host "   Response content: $($categoriesResponse.Content)" -ForegroundColor Yellow
    }
} catch {
